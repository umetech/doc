...
```ini
keyword:       (string) search keyword, default is empty
category:      (int) the number of games returned, default is 10
title:         (string) country & language region code, e.g. en_US, de_De. default is en_US
image:         (string) forward page identification, generated by API interface
price:         (string) backward page identification, generated by API interface
```
